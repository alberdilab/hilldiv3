---
title: "Case 1: Dietary niches of insectivorous bats"
---
...
> diversity order `q`, alpha/beta diversity or phylogenetic diversity are
...
cumulative: adding `tree =` returns neutral *and* phylogenetic diversity
together in one tibble, tagged by a `type` column (`type =` keeps just one).
