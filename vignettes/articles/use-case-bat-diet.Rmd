...
```{r ordination, fig.width = 5, fig.height = 4, fig.alt = "PCoA of pairwise dietary dissimilarity, coloured by habitat"}
...
The first axis cleanly separates forest from farmland individuals, recovering
the habitat-level dietary structure that the hierarchical partition quantified.
