...
objects work too — see [Preparing your data](preparing-data.html).
...
* [**Diversity types**](diversity-types.html) — neutral, phylogenetic and
  functional measurement.
* [**Partitioning and (dis)similarity**](partitioning-and-dissimilarity.html) —
  alpha/beta/gamma, the S/C/U/V metrics, and pairwise dissimilarity for
  ordination.
* [**Profiles, evenness and redundancy**](profiles-evenness-redundancy.html) —
  `hillprof()`, `hilleven()`, `hillred()`.
* [**Preparing your data**](preparing-data.html) — input formats,
